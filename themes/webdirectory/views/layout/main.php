...
<link href="/css/webdirectory.css?v<?=Html::getStaticFileVersion('webdirectory.css', 'css')?>" rel="stylesheet">
</head>
<body>
    ...
    <div class="modal-mask" id="modal_about">
        <div class="modal-about">
            ...
            <div class="modal-body markdown-body">
                <?php echo !empty($viewData['htmlContact']) ? $viewData['htmlContact'] : ''; ?>
            </div>
        </div>
    </div>
